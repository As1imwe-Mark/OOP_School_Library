...
# 📖 OOP_School_Library <a name="about-project"></a>
 ...
 This is a program that records what books are in the library and who borrows them.

## 🛠 Built With <a name="built-with"></a>

The project is built to help in record keeping.
...
```
git clone https://github.com/As1imwe-Mark/OOP_School_Library
...
Feel free to check the [issues page](https://github.com/As1imwe-Mark/OOP_School_Library/issues).
...
We would like to thank Microverse the opportunity.
